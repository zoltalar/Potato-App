export default {
  ...
  messages: {
    ...
    account_events: 'List below contains all your events.',
    ...
    meta_description_events_edit: 'Edit event information (address, description, photos, etc.)',
    ...
    page_title_cities: "Farms, farmers' markets and farm products - {location} and surrounding areas",
