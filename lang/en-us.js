export default {
  ...
  messages: {
    ...
    codename: 'Potato',
    comment_created: 'Comment has been created successfully.',
    ...
    event_address_use: 'Would you like to use <strong>{address}</strong>?',
    ...
    meta_description_index: "Find locally grown organic food from farmers and farmers' markets",
    ...
    meta_description_product: 'Nutrition facts, top growing and selling areas, price chart for {item}',
    ...
    model_footer: 'Created on {date} at {time} by {user}.',
    ...
    page_title_farms_deactivate: 'Deactivate farm - {name}',
    ...
    page_title_markets_deactivate: "Deactivate farmers' market - {name}",
    ...
    search_food: 'Find locally grown organic food',
  ...
  phrases: {
    ...
    comments: 'Comments',
    comments_to_this_review: 'Comments to this Review',
