export default {
  ...
  messages: {
    ...
    farms_search_empty: '<p>Sorry, but we did not find any farms.</p><hr /><p>Please help us complete the database of local farms:</p>',
    ...
    markets_search_empty: "<p>Sorry, but we did not find any farmers' markets.</p><hr /><p>Please help us complete the database of local farmers' markets:</p>",
