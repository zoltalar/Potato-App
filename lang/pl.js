export default {
  ...
  messages: {
    ...
    account_events: 'Lista poniżej zawiera wszystkie Twoje wydarzenia związane z rolnictwem i zdrową żywnością.',
    account_events_empty: 'W chwili obecnej nie posiadasz żadnych wydarzeń do Twoich gospodarstw rolnych lub agromarketów.',
    ...
    comment_created: 'Komentarz został utworzony pomyślnie.',
    ...
    event_address_deleted: 'Adres wydarzenia został usunięty pomyślnie.',
    event_address_updated: 'Adres wydarzenia został zaktualizowany pomyślnie.',
    event_address_use: 'Czy chcesz użyć adresu <strong>{address}</strong>?',
    event_unapproved: 'Wydarzenie jest obecnie niezatwierdzone.',
    event_created: 'Wydarzenie zostało utworzone pomyślnie.',
    event_deleted: 'Wydarzenie zostało usunięte pomyślnie.',
    event_description_updated: 'Opis wydarzenia został zaktualizowany pomyślnie.',
    event_eventable_id: 'Wybierz z listy organizatora wydarzenia. Musisz posiadać przynajmniej jedno gospodarstwo rolne lub agromarket.',
    event_eventable_type: 'Użyj tego filtra aby wyświetlić w liście Organizatorów Twoje gospodarstwa rolne albo agromarkety.',
    event_footer: 'Utworzono dnia {date} o godzinie {time} dla {eventable}.',
    event_general_information_email: 'Adres email nie zostanie pokazany na stronie szczegółowej wydarzenia lecz umożliwi użytkownikom kontaktowanie się przez opcję <em>Wyślij Wiadomość</em>.',
    event_general_information_updated: 'Dane ogólne wydarzenia zostały zaktualizowane pomyślnie.',
    events_search: 'Szukasz wydarzeń związanych z rolnictwem lub zdrową żywnością w okolicy miejscowości <strong>{location}</strong>.',
    events_search_empty: '<p>Przykro nam ale nie znaleźliśmy żadnych wydarzeń.</p><p>Jeśli wiesz o wydarzeniach związanych z rolnictwem lub zdrową żywnością, prosimy kliknąć poniższy przycisk:</p>',
    ...
    locally_grown: 'Lokalnie Uprawiane ({season})',
    ...
    markets_empty: 'W tym obszarze nie ma jeszcze agromarketów do wyświetlenia. Pomóż nam uzupełnić bazę lokalnych agromarketów z okolic miejscowości {location}.',
    markets_search: 'Szukasz agromarketów sprzedających <strong>{item}</strong> w okolicy miejscowości <strong>{location}</strong>.',
    markets_search_empty: '<p>Przykro nam ale nie znaleźliśmy żadnych agromarketów.</p><p>Prosimy pomóż nam uzupełnić bazę lokalnych agromarketów:</p>',
    ...
    meta_description_email_verify: 'Zweryfikuj adres email przez kod weryfikacyjny',
    meta_description_events_add: 'Dodaj wydarzenie',
    meta_description_events_edit: 'Edytuj informacje o wydarzeniu (adres, opis itp.)',
    meta_description_events_search: 'Szukaj wydarzeń w okolicy miejscowości {location}',
    meta_description_events_show: 'Szczegóły dotyczące wydarzenia: {title}',
    ...
    meta_description_markets_edit: 'Edytuj informacje agromarketu (adres, opis, godziny otwarcia, produkty, zdjęcia, media społecznościowe, itp.)',
    meta_description_markets_search: 'Szukaj agromarketów w okolicy miejscowości {location} sprzedających {item}',
    meta_description_markets_show: 'Szczegóły dotyczące agromarketu: {name}',
    meta_description_messages_show: 'Szczegóły wiadomości',
    meta_description_my_account_contact_information: 'Moje dane kontaktowe',
    meta_description_my_account_events: 'Lista moich wydarzeń',
    ...
    page_title_cities: 'Gospodarstwa, agromarkety, lokalne wydarzenia i produkty rolne - {location} i okolice',
  ...
  phrases: {
    ...
    back: 'Powrót',
    browse_events_map: 'Przeglądaj Mapę Wydarzeń',
    ...
    closed: 'Zamknięte',
    comment: 'Komentarz',
    comment_on_this_review: 'Skomentuj tę Recenzję',
    comments: 'Komentarze',
    comments_to_this_review: 'Komentarze do tej Recenzji',
    ...
    edit_general_information: 'Edytuj Dane Ogólne',
    ...
    enter_verification_code: 'Wpisz Kod Weryfikacyjny',
    ...
    farms_search_results: 'Wyniki wyszukiwania gospodarstw rolnych',
    favorites: 'Ulubione',
    fax: 'Faks',
    featured_farmers_markets: 'Wyróżnione Agromarkety',
    featured_farms: 'Wyróżnione Gospodarstwa Rolne',
    first_name: 'Imię',
    ...
    gallons: 'Galony',
    general: 'Ogólne',
    general_information: 'Dane Ogólne',
    ...
    last_name: 'Nazwisko',
    liter: 'Litr',
    local_events: 'Wydarzenia Lokalne',
    login: 'Logowanie',
    logout: 'Wyloguj',
    mailing_address: 'Adres do Korespondencji',
    markets: 'Agromarkety',
    markets_search_results: 'Wyniki wyszukiwania agromarketów',
    message: 'Wiadomość',
    ...
    monday: 'Poniedziałek',
    months: 'Miesiące',
    more_farms: 'Więcej Gospodarstw Rolnych',
    more_farmers_markets: 'Więcej Agromarketów',
    ...
    password_update: 'Aktualizacja Hasła',
    phone: 'Telefon',
    photo: 'Zdjęcie',
    ...
    reply: 'Odpisz',
    request_code: 'Wyślij Kod',
    request_another_link: 'Wyślij Kolejny Link',
    reset: 'Resetuj',
    review: 'Recenzja',
    review_comment: 'Komentarz Recenzji',
    reviews: 'Recenzje',
    reviews_count: 'Liczba Recenzji',
    saturday: 'Sobota',
    save: 'Zapisz',
    scope: 'Zakres',
    search: 'Szukaj',
    ...
    top_selling_areas: 'Największe Obszary Sprzedaży',
    town: 'Miejscowość',
    twitter: 'Twitter',
    tuesday: 'Wtorek',
    type: 'Typ',
