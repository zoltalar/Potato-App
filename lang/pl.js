export default {
  ...
  messages: {
    ...
    farms_search_empty: '<p>Przykro nam ale nie znaleźliśmy żadnych gospodarstw rolnych.</p><hr /><p>Prosimy pomóż nam uzupełnić bazę lokalnych gospodarstw rolnych:</p>',
    ...
    markets_search_empty: '<p>Przykro nam ale nie znaleźliśmy żadnych agromarketów.</p><hr /><p>Prosimy pomóż nam uzupełnić bazę lokalnych agromarketów:</p>',
    ...
    meta_description_products: 'Przeglądaj produkty rolne, znajdź największe obszary upraw i monitoruj ceny',
    ...
    page_title_farms_search: '{item} w {location} - Wyniki wyszukiwania gospodarstw rolnych',
    page_title_farms_show: '{name}, {address} - Gospodarstwo rolne',
    page_title_markets_search: '{item} w {location} - Wyniki wyszukiwania agromarketów',
