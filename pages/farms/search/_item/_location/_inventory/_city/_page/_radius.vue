...
export default {
  ...
  head () {
    return {
      ...
      meta: [
        { hid: 'description', name: 'description', content: this.$t('messages.meta_description_farms_search', { item: this.itemName, location: this.locationName }) },
        { hid: 'og:title', name: 'og:title', content: this.$t('messages.page_title_farms_search', { item: this.itemName, location: this.locationName }) },
        { hid: 'og:description', name: 'og:description', content: this.$t('messages.meta_description_farms_search', { item: this.itemName, location: this.locationName }) },
